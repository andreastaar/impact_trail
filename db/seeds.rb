...
ofertas = Offer.create!(
  [
    ...
    { title: 'Voluntariado en Educación Infantil', description: 'Apoyar en la educación de niños en situación de vulnerabilidad.', requirements: 'Paciencia y habilidades educativas.', start_date: '2024-10-01', end_date: '2024-12-31', availability: 4, user: usuarios[0], address: 'Av. Reforma 123, Ciudad de México', latitude: 19.4326, longitude: -99.1332 },
    { title: 'Asistencia en Refugio para Personas Sin Hogar', description: 'Ayudar en la gestión y asistencia en el refugio.', requirements: 'Experiencia en trabajo social es deseable.', start_date: '2024-10-05', end_date: '2024-12-30', availability: 5, user: usuarios[0], address: 'Calle 5 de Febrero 456, Ciudad de México', latitude: 19.4326, longitude: -99.1332 },
    { title: 'Campaña de Recaudación de Fondos', description: 'Organizar eventos para recaudar fondos para la organización.', requirements: 'Experiencia en eventos o marketing.', start_date: '2024-10-10', end_date: '2024-12-15', availability: 3, user: usuarios[0], address: 'Plaza Central 789, Ciudad de México', latitude: 19.4326, longitude: -99.1332 },

    # Ofertas para Sofía Ramírez
    { title: 'Apoyo en Centro de Día para Adultos Mayores', description: 'Asistir en actividades y cuidados de adultos mayores.', requirements: 'Empatía y habilidades para el cuidado.', start_date: '2024-10-02', end_date: '2024-12-31', availability: 4, user: usuarios[1], address: 'Calle 72 #23, Bogotá', latitude: 4.7110, longitude: -74.0721 },
    { title: 'Talleres de Capacitación para Jóvenes', description: 'Conducir talleres para el desarrollo de habilidades en jóvenes.', requirements: 'Habilidades en educación y liderazgo.', start_date: '2024-10-07', end_date: '2024-12-20', availability: 4, user: usuarios[1], address: 'Carrera 13 #45-67, Bogotá', latitude: 4.7110, longitude: -74.0721 },
